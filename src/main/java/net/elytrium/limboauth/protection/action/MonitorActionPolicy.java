...
/**
 * Monitor-only: never interferes with the player. Logging, storage and alerting
 * are handled by the dispatch stage, not by the action policy.
 */
public class MonitorActionPolicy implements ActionPolicy {
