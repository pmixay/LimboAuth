...
public enum RiskFactor {
  ...
  IP_FOREIGN_TARGET_SPREAD(FactorCategory.DISTRIBUTION),
  PASSWORD_SPRAY(FactorCategory.DISTRIBUTION),
  CHURN_SESSIONS(FactorCategory.DISTRIBUTION),
  MULTI_ACCOUNT_NEW_SOURCE_SUCCESS(FactorCategory.DISTRIBUTION),
  DORMANT_ACCOUNT_TAKEOVER(FactorCategory.DISTRIBUTION),
  ...
  CONFIRM_SUCCESS_FROM_MULTI_TARGET_SOURCE(FactorCategory.CONFIRMATION);
